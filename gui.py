...
class CanWindow(QtGui.QWidget):
    ...
    def init_ui(self):
        ...
        vbox.addWidget(CreateGroupBox(self.can_table_control,'Test'))
        vbox.addWidget(CreateGroupBox(self.send_can,'Test'))
        vbox.addWidget(CreateGroupBox(self.edit_host,'Test'))
        vbox.addStretch()
